...
export default class Database {
  ...
  async open() {
    ...
    this.userCollection = currDb.collection('user');
    this.checkRecordCollection = currDb.collection('checkRecord');
    this.itemCollection = currDb.collection('item');
    this.shopRecordCollection = currDb.collection('shopRecord');
    this.roomCollection = currDb.collection('room');
    //
